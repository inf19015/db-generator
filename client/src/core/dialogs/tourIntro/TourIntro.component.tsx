...
// TODO enum
type Tour = 'intro' | 'tablesPanel' | 'previewPanel' | 'dependencies';
		...
		<>
			<Dialog onClose={closeIntroDialog} open={tourIntroDialogVisible}>
				<div style={{ width: 600 }}>
					...
					<DialogContent dividers className={styles.introDialog}>
						<div className={styles.cols}>
							...
							<div className={`${styles.col} ${styles.buttonCol}`}>
								...
								<div>
									<PrimaryButton onClick={(): void => selectTour('tablesPanel')}>
										2. {i18n.theTablesPanel}
									</PrimaryButton>
								</div>
								<div>
								...
								<div>
									<PrimaryButton onClick={(): void => selectTour('dependencies')}>
										4. {i18n.dependencies}
									</PrimaryButton>
								</div>
							</div>
					...
					<DialogActions>
						<PrimaryButton onClick={closeIntroDialog} color="inherit">{i18n.close}</PrimaryButton>
					</DialogActions>
				</div>
